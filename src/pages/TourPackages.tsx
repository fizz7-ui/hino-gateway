  ...
  const destinations = [
    {
      name: "Thailand",
      icon: "🇹🇭",
      desc: "Exotic beaches, nightlife, and cultural heritage",
    },
    {
      name: "Hong Kong",
      icon: "🇭🇰",
      desc: "Modern city attractions with traditional charm",
    },
    {
      name: "China",
      icon: "🇨🇳",
      desc: "Great Wall, rich culture, and historical wonders",
    },
    {
      name: "Singapore",
      icon: "🇸🇬",
      desc: "A clean, safe, and family-friendly destination",
    },
    {
      name: "Sri Lanka",
      icon: "🇱🇰",
      desc: "Stunning beaches, nature, and historical sites",
    },
    {
      name: "Maldives",
      icon: "🇲🇻",
      desc: "Luxury resorts, clear waters, and honeymoon heaven",
    },
    {
      name: "Nepal",
      icon: "🇳🇵",
      desc: "The Himalayas, adventure, and spiritual journeys",
    },
    {
      name: "UAE",
      icon: "🇦🇪",
      desc: "Luxury, shopping, and desert adventures",
    },
    {
      name: "Spain",
      icon: "🇪🇸",
      desc: "Flamenco, football, and cultural festivals",
    },
    {
      name: "France",
      icon: "🇫🇷",
      desc: "Paris, romance, and world-class landmarks",
    },
    {
      name: "Romania",
      icon: "🇷🇴",
      desc: "Beautiful landscapes and medieval castles",
    },
    {
      name: "Italy",
      icon: "🇮🇹",
      desc: "Art, history, architecture, and delicious cuisine",
    },
    {
      name: "Canada",
      icon: "🇨🇦",
      desc: "Natural beauty, modern cities, and friendly people",
    },
    {
      name: "USA",
      icon: "🇺🇸",
      desc: "Endless attractions, shopping, and entertainment",
    },
  ];
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <Center>
            <Reveal>
              <img
                src="https://royalrollsmanpower.com/wp-content/uploads/2025/08/image-travel-and-tours-1024x197.jpg"
                alt=""
                width={500}
              />
            </Reveal>
          ...
          <Reveal>
            <div>
              ...
              <p className="text-lg text-center max-w-4xl mx-auto">
                Image Travel & Tours specializes in providing affordable, safe,
                and customized travel packages to the world's most popular
                destinations. Whether it's a family vacation, honeymoon,
                adventure tour, or business trip – we make your journey simple,
          ...
          <Reveal>
            <div>
              <p className="text-center text-muted-foreground mb-12">
                Explore the beauty of the world with our exclusive packages:
              </p>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {destinations.map((dest, index) => (
                  <Reveal key={index}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Reveal>
              <div className="bg-card p-6 rounded-lg border text-center">
                ...
                <p className="text-muted-foreground">
                  Years of experience in travel planning
                </p>
              </div>
            </Reveal>
            <Reveal>
              <div className="bg-card p-6 rounded-lg border text-center">
                ...
                <p className="text-muted-foreground">
                  Complete travel documentation assistance
                </p>
              </div>
            </Reveal>
            <Reveal>
            ...
            <Reveal>
              <div className="bg-card p-6 rounded-lg border text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Complete Booking</h3>
                <p className="text-muted-foreground">
                  Flight & hotel reservation included
                </p>
              </div>
            </Reveal>
            <Reveal>
            ...
            {[
              {
                ...
                desc: "Carefully curated travel experiences",
              },
              {
                title: "Visa Processing Assistance",
                desc: "Expert help with travel documentation",
              },
              {
                title: "Air Ticketing & Hotel Booking",
                desc: "Complete travel arrangements",
              },
              {
              ...
              },
              {
                ...
                desc: "Special moments, perfectly planned",
              },
              {
                title: "Corporate & Business Travel",
                desc: "Professional travel arrangements",
              },
            ].map((service, idx) => (
              <Reveal key={idx}>
                <div className="bg-card p-6 rounded-lg border">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Reveal>
            <div>
              <p className="text-xl text-muted-foreground mb-8">
                At Image Travel & Tours, we don't just plan trips – we create
                memories that last forever. From start to finish, our team
                ensures your journey is comfortable, enjoyable, and stress-free.
              </p>
              <p className="text-lg text-primary font-semibold mb-8">
                Travel with confidence, travel with Image Travel & Tours.
              </p>
