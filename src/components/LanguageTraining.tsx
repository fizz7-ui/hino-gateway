        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="space-y-6">
              {programs.map((program, index) => (
                <Reveal key={index}>
                  <div className="bg-card border-2 border-border rounded-xl p-6 hover:border-primary hover:shadow-red transition-all duration-300">
                    <div className="flex items-start space-x-4">
                      <div className="p-3 bg-primary/10 rounded-lg flex-shrink-0">
                        <program.icon className="text-primary" size={28} />
                      </div>
          ...
          <Reveal>
            <div className=" justify-center bg-primary/5 border-2 border-primary/20 rounded-2xl p-8 md:p-12 text-center">
              <Globe className="text-primary mx-auto mb-6" size={56} />
